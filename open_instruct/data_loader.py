...
class HFDataLoader(data_loader.DataLoaderBase):
    ...
    def __init__(
        ...
        self._epoch: int = 0  # Start at epoch 0 to match HuggingFace/accelerate default
    ...
    def _reshard(self, epoch: int) -> None:
        ...
        Uses a local Generator with seed + epoch to match accelerate's SeedableRandomSampler.
        """
